...
namespace Universidad.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        {
            var aplicationDbContext = _context.Enrollment.Include(e => e.Course).Include(e => e.Student);
        ...
        {
            ViewData["CourseId"] = new SelectList(_context.Course, "CourseId", "Credito");
        ...
        public async Task<IActionResult> Create([Bind("EnrollmentID,CourseId,StudentId,Grade")] Enrollment enrollment)
        {
            ...
            ViewData["CourseId"] = new SelectList(_context.Course, "CourseId", "Credito", enrollment.CourseId);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AplicationDbContext.Enrollment'  is null.");
            }
            var enrollment = await _context.Enrollment.FindAsync(id);
            if (enrollment != null)
            {
